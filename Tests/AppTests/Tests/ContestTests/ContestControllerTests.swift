...
//                headers: HTTPHeaders([bearerHeader(token.refreshToken)]), content: contest
//            )
//        { response in
...
//                headers: HTTPHeaders([bearerHeader(token.refreshToken)])
//            )
//        { response in
//            let receivedContest = try response.content.decode(Contest.Detail.self)
//            XCTAssertNotNil(receivedContest.id)
...
//        let token = try create(.mock(), app)
//        let contest = try await seedContest(app)
//        try await join(contest.id, userToken: token.refreshToken, app: app)
//        
//        try app.testable(method: .inMemory)
//            .test(
...
//            .test(
//                .POST, "/api/contest/\(contest.id)/leave",
//                headers: HTTPHeaders([bearerHeader(rootToken.refreshToken)])
//            )
//        { response in
//            XCTAssertEqual(response.status, .badRequest)
//        }
...
//        .init(email: "mock@jock.com", password: "password", fullName: "Ivo T")
//    }
//}
